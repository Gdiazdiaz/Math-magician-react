...
**This first react repository** is a project where we use React to build a Calculator in a one-page website.
...
- [Live Demo](https://math-magician-zczk.onrender.com)
...
- [ ] **It will allow to run operations such as add/substract/divide/multiply**
...
Feel free to check the [issues page](https://github.com/Gdiazdiaz/Math-magician-react/issues).
